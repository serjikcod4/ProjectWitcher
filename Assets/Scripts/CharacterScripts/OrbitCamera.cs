...
public class OrbitCamera : MonoBehaviour
{
    ...
    //Храним расстояние до камеры, без препятствий.
    ...
    private void CameraMove(bool CameraObstacle, Quaternion Rotation)
    {
        switch(CameraObstacle)
        {
            ...
            case false:
                ...
                if (Vector3.Distance(Player.transform.position, transform.position) == Vector3.Distance(Player.transform.position, Offset))
                {
                    OffsetTemp = Offset;
                }
